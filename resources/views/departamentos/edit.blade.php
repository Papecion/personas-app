    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('departamentos.update', ['departamento' => $departamento->depa_codi]) }}">
            ...
            <div class="mb-3">
                ...
                <div id="codigoHelp" class="form-text">Deparment Id.</div>
            </div>
            <div class="mb-3">
                <label for="name" class="form-label">Deparment</label>
                <input type="text" required class="form-control" id="name" placeholder="Deparment name"
